...
const (
	...
	// local connect other
	MSGTYPE_LOCAL_CONNECT_OTHER MSGTYPE = 10
	// local connect root
	MSGTYPE_LOCAL_CONNECT_ROOT MSGTYPE = 11
	// reply connect root
	MSGTYPE_REPLY_CONNECT_ROOT MSGTYPE = 12
	// local connect root
	MSGTYPE_CONNECT_ROOT MSGTYPE = 13
)
...
var MSGTYPE_name = map[int32]string{
	...
	8:  "NODE_INFO",
	9:  "REPLY_CONNECT",
	10: "LOCAL_CONNECT_OTHER",
	11: "LOCAL_CONNECT_ROOT",
	12: "REPLY_CONNECT_ROOT",
	13: "CONNECT_ROOT",
}
var MSGTYPE_value = map[string]int32{
	...
	"NODE_INFO":           8,
	"REPLY_CONNECT":       9,
	"LOCAL_CONNECT_OTHER": 10,
	"LOCAL_CONNECT_ROOT":  11,
	"REPLY_CONNECT_ROOT":  12,
	"CONNECT_ROOT":        13,
}
...
func (MSGTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_4782868eb4904ecb, []int{0}
}
...
func (*ReplyJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_4782868eb4904ecb, []int{1}
}
...
func (*CtrlInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_4782868eb4904ecb, []int{2}
}
...
func (*CtrlResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_4782868eb4904ecb, []int{3}
}
...
func (*JarvisMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_4782868eb4904ecb, []int{4}
}
...
func init() { proto.RegisterFile("jarviscore.proto", fileDescriptor_jarviscore_4782868eb4904ecb) }

var fileDescriptor_jarviscore_4782868eb4904ecb = []byte{
	// 587 bytes of a gzipped FileDescriptorProto
	,
}
