...
func (MSGTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_94ce5bd78a02c36c, []int{0}
}
...
func (REPLYTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_94ce5bd78a02c36c, []int{1}
}
...
func (*ReplyJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_94ce5bd78a02c36c, []int{2}
}
...
func (*CtrlScriptData) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_94ce5bd78a02c36c, []int{3}
}
...
func (*CtrlInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_94ce5bd78a02c36c, []int{4}
}
...
func (*CtrlResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_94ce5bd78a02c36c, []int{5}
}
...
func (*JarvisMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_94ce5bd78a02c36c, []int{6}
}
...
func init() { proto.RegisterFile("jarviscore.proto", fileDescriptor_jarviscore_94ce5bd78a02c36c) }

var fileDescriptor_jarviscore_94ce5bd78a02c36c = []byte{
	// 795 bytes of a gzipped FileDescriptorProto
	,
}
