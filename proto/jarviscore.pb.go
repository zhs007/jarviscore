...
func (MSGTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_b25b7851be9b4b77, []int{0}
}
...
func (REPLYTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_b25b7851be9b4b77, []int{1}
}
...
func (*ReplyJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_b25b7851be9b4b77, []int{2}
}
...
func (*CtrlScriptData) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_b25b7851be9b4b77, []int{3}
}
...
func (*CtrlInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_b25b7851be9b4b77, []int{4}
}
...
func (*CtrlResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_b25b7851be9b4b77, []int{5}
}
...
func (*JarvisMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_b25b7851be9b4b77, []int{6}
}
...
func init() { proto.RegisterFile("jarviscore.proto", fileDescriptor_jarviscore_b25b7851be9b4b77) }

var fileDescriptor_jarviscore_b25b7851be9b4b77 = []byte{
	// 803 bytes of a gzipped FileDescriptorProto
	,
}
