...
func (CODE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{0}
}
...
func (NODETYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{1}
}
...
func (CHANNELTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{2}
}
...
func (*Subscribe) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{3}
}
...
func (*NodeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{4}
}
...
func (*CtrlInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{5}
}
...
func (*CtrlResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{6}
}
...
func (*ChannelInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_90f4f811ec3b8da9, []int{7}
}
...
func init() { proto.RegisterFile("jarviscore.proto", fileDescriptor_jarviscore_90f4f811ec3b8da9) }

var fileDescriptor_jarviscore_90f4f811ec3b8da9 = []byte{
	// 637 bytes of a gzipped FileDescriptorProto
	,
}
