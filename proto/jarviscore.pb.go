...
func (MSGTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{0}
}
...
func (REPLYTYPE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{1}
}
...
func (*ReplyJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{2}
}
...
func (*FileData) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{3}
}
...
func (*RequestFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{4}
}
...
func (*CtrlScriptData) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{5}
}
...
func (*CtrlScript2Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{6}
}
...
func (*CtrlInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{7}
}
...
func (*CtrlResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{8}
}
...
func (*MultiMsgData) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{9}
}
...
func (*JarvisMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_jarviscore_698936b976e41c5d, []int{10}
}
...
func init() { proto.RegisterFile("jarviscore.proto", fileDescriptor_jarviscore_698936b976e41c5d) }

var fileDescriptor_jarviscore_698936b976e41c5d = []byte{
	// 1072 bytes of a gzipped FileDescriptorProto
	,
}
