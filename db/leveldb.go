...
func (db *jarvisLDB) GetPath() string {
	return db.dbpath
}

// Put puts the given key / value to the queue
func (db *jarvisLDB) Put(key []byte, value []byte) error {
	return db.db.Put(key, value, nil)
}

func (db *jarvisLDB) Has(key []byte) (bool, error) {
	return db.db.Has(key, nil)
}

// Get returns the given key if it's present.
func (db *jarvisLDB) Get(key []byte) ([]byte, error) {
...
func (db *jarvisLDB) Delete(key []byte) error {
	return db.db.Delete(key, nil)
}

func (db *jarvisLDB) NewIterator() iterator.Iterator {
	return db.db.NewIterator(nil, nil)
}

// NewIteratorWithPrefix returns a iterator to iterate over subset of database content with a particular prefix.
func (db *jarvisLDB) NewIteratorWithPrefix(prefix []byte) iterator.Iterator {
	return db.db.NewIterator(util.BytesPrefix(prefix), nil)
}

func (db *jarvisLDB) Close() {
...
func (db *jarvisLDB) LDB() *leveldb.DB {
	return db.db
}

func (db *jarvisLDB) NewBatch() Batch {
